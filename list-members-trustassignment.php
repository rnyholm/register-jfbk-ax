...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Alarmavdelningen - Förtroendeuppdrag</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar i alarmavdelningen med förtroendeuppdrag</h2>
				<p>På denna sida listas manskap i alarmavdelningen som har någon form av förtroendeuppdrag.<br />
				...
				<p>
					...
					<input type="submit" name="listTrustassignmentMembersPfriendly" id="listTrustassignmentMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-members-trustassignment-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=700,height=900')" />
				</p>
				<h2>Manskap med förtroendeuppdrag i Alarmavdelningen <?php echo date("Y"); ?></h2>
				
				<p>
					Det finns <b><u><?php echo(get_no_of_members_with_assignmentintrust()); ?></u></b> medlemmar i alarmavdelningen som har förtroendeuppdrag.<br />
				</p>				
				...
				<table id="jfbk_table" style="width: auto;">
					...
					<?php	
						...
						$result = get_nfo_assignmentintrust_members();
