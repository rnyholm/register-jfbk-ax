...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Ungdomsavdelningen - Ny Medlem</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Lägg till ny medlem i ungdomsavdelningen</h2>
				<p>För att lägga till en ny medlem i ungdomsavdelningen fyller du helt enkelt i formuläret nedan<br />
				...
				<table id="form_table">
					<tr>
						<td>
							<form id="addJunCrewForm" name="addJunCrewForm" method="post" action="add-jun-member-exec.php">
						...
						<td align="left" valign="top">
							<?php
								if( isset($_SESSION['ERRMSG_ARR']) && is_array($_SESSION['ERRMSG_ARR']) && count($_SESSION['ERRMSG_ARR']) >0 ) {
									...
									echo '<div id="success">';
									echo '<font class="result_heading">Ny medlem har lagts till i ungdomsavdelningen!</font><br />';
