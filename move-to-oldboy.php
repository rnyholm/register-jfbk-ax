...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Alarmavdelningen - Flytta Medlem Till Oldboysavdelningen</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Flytta medlem till oldboysavdelningen</h2>
				<p>Medlemmen som ska flyttas till oldboysavdelningen väljs ur listan nedan, sedan anger du ditt lösenord<br />
				för att bekräfta att du har behörighet att utföra åtgärden. Till sist klickar du på "Flytta medlem", då kommer<br />
				medlemmen och personens information att flyttas till oldboysavdelningen.</p>
				<p class="red">OBS! Medlem som flyttats till oldboysavdelningen kan inte flyttas tillbaka till alarmavdelningen igen!</p>
				
				<!--Table holding content for change password and error messages-->
				<table id="form_table">
					<tr>
						<td>
							<form id="moveToOldboysForm" name="moveToOldboysForm" method="post" action="move-to-oldboy-exec.php">
						...
						<td valign="top">
							<?php
								if( isset($_SESSION['ERRMSG_ARR']) && is_array($_SESSION['ERRMSG_ARR']) && count($_SESSION['ERRMSG_ARR']) >0 ) {
									...
									echo '<div id="success">';
									echo '<font class="result_heading">Medlemmen har flyttats till oldboysavdelningen!</font><br />';
									echo '<p class="result_paragraph">I fortsättningen ändrar du personens information <br />via oldboysavdelningens menyer.</p>';
									echo '</div>';
