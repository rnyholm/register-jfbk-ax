	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört Rökdykare- och/eller Basic Fire Fighting utbildningen</h2>
				...
				<p>
					...
					<input type="submit" name="listSmokediverMembersPfriendly" id="listSmokediverMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-smokediver-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=650,height=900')" />
				</p>
