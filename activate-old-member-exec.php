<?php
	...
	$member_data['selected_member'] = $_POST['inactiveOldMemberSelect'];
	...
	if(!$errflag) {
		...
		if($result) {
			...
			if(mysql_num_rows($result) == 1) {
				...
				$qry = "UPDATE crew SET active='true' WHERE crew_id='".clean($_POST['inactiveOldMemberSelect'])."'";
				...
				session_write_close();
				ob_clean();
				header("location: activate-old-member.php");
				exit();
