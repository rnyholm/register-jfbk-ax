	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				...
				<p>På denna sida sida ser du en sammanställning över ungdomsavdelningen för år <?php echo date('Y');?>. För att skriva ut<br />
				denna sammanställning klickar du helt enkelt på knappen "Utskriftsvänlig version" nedan. Om du<br />
				kommer på att någon uppgift är felaktig kan du klicka på "Redigera medlemmar" knappen nedan eller gå in via "Ungdomsavdelningen"<br />
				menyn uppe på sidan och sedan välja "Redigera befintlig medlem".<br />
				Alla dessa uppgifter gäller personer som är aktiva medlemmar i ungdomsavdelningen. För att få en övergripande blick över de<br />
				andra avdelningarna går du in på respektive avdelnings meny och klickar sedan på "Visa sammanställning".</p>
				
				<input type="submit" name="getJunDepartmentReportPfriendly" id="getJunDepartmentReporPfriendly" value="Utskriftsvänlig version" onclick="window.open('jun-department-report-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=750,height=900')" />
