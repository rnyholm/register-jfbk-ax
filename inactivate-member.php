...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Alarmavdelningen - Inaktivera Medlem</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Inaktivera medlem i alarmavdelningen</h2>
				...
				medlemmen som inaktiv och kommer inte räknas som aktivt manskap i alarmavdelningen på dessa sidor.</p>
				...
				<table id="form_table">
					<tr>
						<td>
							<form id="inactivateMemberForm" name="inactivateMemberForm" method="post" action="inactivate-member-exec.php">
