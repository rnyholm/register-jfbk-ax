...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Oldboysavdelningen - Ny Medlem</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Lägg till ny medlem i oldboysavdelningen</h2>
				<p>För att lägga till en ny medlem oldboysavdelningen fyller du helt enkelt i formuläret nedan<br />
				...
				<table id="form_table">
					<tr>
						<td>
							<form id="addOldCrewForm" name="addOldCrewForm" method="post" action="add-old-member-exec.php">
						...
						<td align="left" valign="top">
							<?php
								if( isset($_SESSION['ERRMSG_ARR']) && is_array($_SESSION['ERRMSG_ARR']) && count($_SESSION['ERRMSG_ARR']) >0 ) {
									...
									echo '<div id="success">';
									echo '<font class="result_heading">Ny medlem har lagts till i oldboysavdelningen!</font><br />';
