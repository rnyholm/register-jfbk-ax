...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Alarmavdelningen - Kontaktlista</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Alarmavdelningens kontaktlista</h2>
				<p>På denna sida listas kontaktuppgifter för manskapet i alarmavdelningen. Även kontaktuppgifter till<br />
				...
				<p>
					...
					<input type="submit" name="listContaclistMembersPfriendly" id="listContactlistMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('contact-list-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=1000,height=900')" />
				</p>
				<h2>Kontaktlista Alarmavdelningen <?php echo date("Y"); ?></h2>				
