...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Ungdomsavdelningen - Lista Nivåkurs 2</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört Nivåkurs 2</h2>
				<p>Denna sida listar alla aktiva medlemmar i ungdomsavdelningen som genomfört Nivåkurs 2. <br />
				...
				<p>
					...
					<input type="submit" name="listLvltwoJunMembersPfriendly" id="listLvltwoJunMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-lvltwo-jun-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=650,height=900')" />
				</p>
				<h2>Jomala FBK's Ungdomar som genomfört Nivåkurs 2 - <?php echo date("Y"); ?></h2>
				
				<p>
					Det finns <b><u><?php echo(get_no_of_lvltwo('ALL')); ?></u></b> medlemmar i ungdomsavdelningen som genomfört Nivåkurs 2.<br />
				</p>
				...
				<table id="jfbk_table" style="width: auto;">
					...
					<?php	
						...
						$result = get_nfo_lvltwo_jmembers();
