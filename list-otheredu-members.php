	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört någon Övrig utbildning</h2>
				<p>Denna sida listar alla aktiva medlemmar i alarmavdelningen som genomfört någon Övrig brandkårs-relaterad <br />
				utbildning. Om något är fel kan du ändra medlemmars information genom att klicka på "Redigera medlem".<br />
				...
				<p>
					...
					<input type="submit" name="listOthereduMembersPfriendly" id="listOthereduMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-otheredu-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=1000,height=900')" />
				</p>
