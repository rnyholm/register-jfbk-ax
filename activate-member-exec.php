<?php
	...
	$member_data['selected_member'] = $_POST['inactiveMemberSelect'];
	...
	if(!$errflag) {
		...
		if($result) {
			...
			if(mysql_num_rows($result) == 1) {
				...
				$qry = "UPDATE crew SET active='true' WHERE crew_id='".clean($_POST['inactiveMemberSelect'])."'";
				...
				session_write_close();
				ob_clean();
				header("location: activate-member.php");
				exit();
