	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Återaktivera medlem i alarmavdelningen</h2>
				...
				listas som aktivt manskap i alarmavdelningen, med alla sina person- och utbildningsuppgifter kvar.</p>
				
				<!--Table holding content for change password and error messages-->
				<table id="form_table">
					<tr>
						<td>
							<form id="activateMemberForm" name="activateMemberForm" method="post" action="activate-member-exec.php">
								<table width="300" id="form_table">
									<tr>
										<th>Välj medlem</th>
										<!--Calling php function from script to populate dropdown list with admins-->
										<td><?php populate_with_inactive_members($_SESSION['MEMBER_DATA']['selected_member']);?></td>
									</tr>
									<tr>
										<th>Lösenord</th>
						...
						<td valign="top">
							<?php
								if( isset($_SESSION['ERRMSG_ARR']) && is_array($_SESSION['ERRMSG_ARR']) && count($_SESSION['ERRMSG_ARR']) >0 ) {
									...
									echo '<div id="success">';
									echo '<font class="result_heading">Medlemmen har återaktiverats till alarmavdelningen!</font><br />';
									echo '</div>';
