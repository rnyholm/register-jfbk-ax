<?php
	...
	for($i=0; $i<11; $i++) {
		...
		$query = "SELECT crew_id FROM crew WHERE seniorstarted='".clean($year)."'";
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Alarmavdelningen - Översikt Medlemstillväxt</title>
	    ...
	    <script type="text/javascript">
	      ...
	      function drawChart() {	
	        ...
	        var options = {
				title: 'Alarmavdelningens medlemstillväxt (10 år)',
