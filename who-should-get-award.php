	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Visa medlemmar som ska tilldelas utmärkelse</h2>
				<p>På denna sida listas alla medlemmar i alarm- och oldboysavdelningen som ska tilldelas en utmärkelse eller uppvaktas.<br />
				Nedan finns två stycken tabeller. Den första listar manskap som ska tilldelas JFBK's- eller FSB's förtjänstetecken.<br />
				Den andra tabellen listar jubilarer som ska uppvaktas, jubilarerna räknas från 50 och uppåt med tio års mellanrum till 80.<br />
				Personer som ska fylla 50,60 osv. listas också under tabellen med jubilarer så att risken ska vara mindre att man missar dem.<br />
				...
				<p>
					<input type="submit" name="WhoShouldGetAwardMembersPfriendly" id="WhoShouldGetAwardMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('who-should-get-award-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=1000,height=900')" />
				</p>
