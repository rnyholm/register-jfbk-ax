...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Utbildning - Lista Räddningsmän</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört Räddningsman utbildningen</h2>
				<p>Denna sida listar alla aktiva medlemmar i alarmavdelningen som genomfört Räddningsman utbildningen. <br />
				...
				<p>
					...
					<input type="submit" name="listRescMembersPfriendly" id="listRescMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-rescmen-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=650,height=900')" />
				</p>
				<h2>Jomala FBK's Räddningsmän <?php echo date("Y"); ?></h2>
				
				<p>
					Det finns <b><u><?php echo(get_no_of_rescmen('ALL')); ?></u></b> räddningsmän i alarmavdelningen.<br />
				</p>
				...
				<table id="jfbk_table" style="width: auto;">
					...
					<?php	
						...
						$result = get_nfo_rescmen_members();
