...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Utbildning - Lista Junior Utbildningar</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört någon Junior utbildning</h2>
				<p>Denna sida listar alla aktiva medlemmar i alarmavdelningen som genomfört någon Junior utbildningen. <br />
				...
				klickar du bara på "Utskriftsvänlig version" så öppnas ett fönster med enbart tabellen, tänk på att <br />
				skriva ut som landskap(liggande) annars blir inte hela tabellen utskriven.</p>
				...
				<p>
					...
					<input type="submit" name="listJunioreduMembersPfriendly" id="listJunioreduMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-junioredu-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=1000,height=900')" />
				</p>
				<h2>Jomala FBK's manskap som genomfört någon Junior utbildning - <?php echo date("Y"); ?></h2>
				
				<p>
					Det finns <b><u><?php echo(get_no_of_junioreducation('ALL')); ?></u></b> medlemmar som genomfört någon Junior utbildning i alarmavdelningen.<br />
				</p>
				...
				<table id="jfbk_table" style="width: auto;">
					...
					<tr>
						<th>Nr</th>
						<th>Namn</th>
						<th>Junior utbildningar</th>
					</tr>
					
					<?php	
						//Get info from database
						$result = get_nfo_junioredu_members();
