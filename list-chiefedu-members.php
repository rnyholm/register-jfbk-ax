...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Utbildning - Lista Kårchef</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört Kårchefs utbildningen</h2>
				<p>Denna sida listar alla aktiva medlemmar i alarmavdelningen som genomfört Kårchefs utbildningen. <br />
				...
				<p>
					...
					<input type="submit" name="listChiefeduMembersPfriendly" id="listChiefeduMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-chiefedu-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=700,height=900')" />
				</p>
				<h2>Jomala FBK's manskap som genomfört Kårchefs utbildningen - <?php echo date("Y"); ?></h2>
				
				<p>
					Det finns <b><u><?php echo(get_no_of_chief('ALL')); ?></u></b> medlemmar som genomfört Kårchefs utbildningen i alarmavdelningen.<br />
				</p>
				...
				<table id="jfbk_table" style="width: auto;">
					...
					<?php	
						...
						$result = get_nfo_chiefedu_members();
