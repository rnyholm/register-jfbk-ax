...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Ungdomsavdelningen - Lista Utbildarkurs</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört Utbildarkursen</h2>
				<p>Denna sida listar alla aktiva medlemmar i ungdomsavdelningen som genomfört Utbildarkursen. <br />
				...
				<p>
					...
					<input type="submit" name="listEduJunMembersPfriendly" id="listEduJunMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-edu-jun-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=650,height=900')" />
				</p>
				<h2>Jomala FBK's Ungdomar som genomfört Utbildarkursen - <?php echo date("Y"); ?></h2>
				
				<p>
					Det finns <b><u><?php echo(get_no_of_education('ALL')); ?></u></b> medlemmar i ungdomsavdelningen som genomfört Utbildarkursen.<br />
				</p>
				...
				<table id="jfbk_table" style="width: auto;">
					...
					<?php	
						...
						$result = get_nfo_education_jmembers();
