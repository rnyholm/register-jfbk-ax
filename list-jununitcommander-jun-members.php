...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Ungdomsavdelningen - Lista Gruppchef</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört Gruppchefs utbildningen</h2>
				<p>Denna sida listar alla aktiva medlemmar i ungdomsavdelningen som genomfört Gruppchefs utbildningen. <br />
				...
				<p>
					...
					<input type="submit" name="listJununitcommanderunMembersPfriendly" id="listJununitcommanderJunMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-jununitcommander-jun-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=650,height=900')" />
				</p>
				<h2>Jomala FBK's Ungdomar som genomfört Gruppchefs utbildningen - <?php echo date("Y"); ?></h2>
				
				<p>
					Det finns <b><u><?php echo(get_no_of_jununitcommander('ALL')); ?></u></b> medlemmar i ungdomsavdelningen som genomfört Gruppchefs utbildningen.<br />
				</p>
				...
				<table id="jfbk_table" style="width: auto;">
					...
					<?php	
						...
						$result = get_nfo_jununitcommander_jmembers();
