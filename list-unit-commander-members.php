...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Utbildning - Lista Enhetschefer</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört Enhetschef utbildningen</h2>
				<p>Denna sida listar alla aktiva medlemmar i alarmavdelningen som genomfört Enhetschef  utbildningen. <br />
				...
				<p>
					...
					<input type="submit" name="listUnitcommanderMembersPfriendly" id="listUnitcommanderMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-unit-commander-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=700,height=900')" />
				</p>
				<h2>Jomala FBK's Enhetschefer <?php echo date("Y"); ?></h2>
				
				<p>
					Det finns <b><u><?php echo(get_no_of_unitcommander('ALL')); ?></u></b> enhetschefer i alarmavdelningen.<br />
				</p>
