...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Utbildning - Lista Syredelegering</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört Syredelegering</h2>
				<p>Denna sida listar alla aktiva medlemmar i alarmavdelningen som genomfört Syredelegering. <br />
				...
				<p>
					...
					<input type="submit" name="listOxygenMembersPfriendly" id="listOxygenMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-oxygen-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=700,height=900')" />
				</p>
				<h2>Jomala FBK's manskap som genomfört Syredelegering - <?php echo date("Y"); ?></h2>
				
				<p>
					Det finns <b><u><?php echo(get_no_of_oxygen('ALL')); ?></u></b> medlemmar som genomfört Syredelegering i alarmavdelningen.<br />
				</p>
