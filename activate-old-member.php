...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Alarmavdelningen - Återaktivera Medlem</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Återaktivera medlem i oldboysavdelningen</h2>
				...
				listas som aktivt manskap i oldboysavdelningen, med alla sina person- och utbildningsuppgifter kvar.</p>
				
				<!--Table holding content for change password and error messages-->
				<table id="form_table">
					<tr>
						<td>
							<form id="activateOldMemberForm" name="activateOldMemberForm" method="post" action="activate-old-member-exec.php">
								<table width="300" id="form_table">
									<tr>
										<th>Välj medlem</th>
										<!--Calling php function from script to populate dropdown list with admins-->
										<td><?php populate_with_inactive_old_members($_SESSION['MEMBER_DATA']['selected_member']);?></td>
									</tr>
									<tr>
										<th>Lösenord</th>
						...
						<td valign="top">
							<?php
								if( isset($_SESSION['ERRMSG_ARR']) && is_array($_SESSION['ERRMSG_ARR']) && count($_SESSION['ERRMSG_ARR']) >0 ) {
									...
									echo '<div id="success">';
									echo '<font class="result_heading">Medlemmen har återaktiverats till oldboysavdelningen!</font><br />';
									echo '</div>';
