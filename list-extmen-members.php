...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Utbildning - Lista Släckningsmän</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört Släckningsman utbildningen</h2>
				<p>Denna sida listar alla aktiva medlemmar i alarmavdelningen som genomfört Släckningsman utbildningen. <br />
				...
				<p>
					...
					<input type="submit" name="listExtMembersPfriendly" id="listExtMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-extmen-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=650,height=900')" />
				</p>
				<h2>Jomala FBK's Släckningsmän <?php echo date("Y"); ?></h2>
				
				<p>
					Det finns <b><u><?php echo(get_no_of_extmen('ALL')); ?></u></b> släckningsmän i alarmavdelningen.<br />
				</p>
