...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Utbildning - Lista Brandkårens FHJ</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört Brandkårens Första Hjälp</h2>
				<p>Denna sida listar alla aktiva medlemmar i alarmavdelningen som genomfört Brandkårens Första Hjälp. <br />
				...
				<p>
					...
					<input type="submit" name="listFirstaidMembersPfriendly" id="listFirstaidMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-firstaid-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=700,height=900')" />
				</p>
				<h2>Jomala FBK's manskap som genomfört Brandkårens FHJ - <?php echo date("Y"); ?></h2>
				
				<p>
					Det finns <b><u><?php echo(get_no_of_firstaid('ALL')); ?></u></b> medlemmar som genomfört Brandkårens FHJ i alarmavdelningen.<br />
				</p>
				...
				<table id="jfbk_table" style="width: auto;">
					...
					<?php	
						...
						$result = get_nfo_firstaid_members();
