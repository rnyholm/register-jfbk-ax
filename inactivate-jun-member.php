...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Jomala FBK - Ungdomsavdelningen - Inaktivera Medlem</title>
	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Inaktivera medlem i ungdomsavdelningen</h2>
				...
				medlemmen som inaktiv och kommer inte räknas som aktivt manskap i ungdomsavdelningen på dessa sidor.</p>
				...
				<table id="form_table">
					<tr>
						<td>
							<form id="inactivateJunMemberForm" name="inactivateJunMemberForm" method="post" action="inactivate-jun-member-exec.php">
