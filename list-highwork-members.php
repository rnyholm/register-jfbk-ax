	...
	<body>
		...
		<div id="body_container">
			<div id="content_container">
				<h2>Medlemmar som genomfört Arbete På Hög Höjd</h2>
				<p>Denna sida listar alla aktiva medlemmar i alarmavdelningen som genomfört Arbete På Hög Höjd. <br />
				...
				<p>
					...
					<input type="submit" name="listHighworkMembersPfriendly" id="listHighworkMembersPfriendly" value="Utskriftsvänlig version" onclick="window.open('list-highwork-members-pfriendly.php','_blank','toolbar=yes,scrollbars=yes,width=700,height=900')" />
				</p>
